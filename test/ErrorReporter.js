...
const priceOraclePath = path.join(__dirname, '..', 'contracts', 'PriceOracle.sol');
const oracleContents = fs.readFileSync(priceOraclePath, 'utf8').toString();
...
const OracleErrorEnum = getEnum(oracleContents, "OracleError");
const OracleFailureInfoEnum = getEnum(oracleContents, "OracleFailureInfo");

const OracleErrorEnumInv = invert(OracleErrorEnum);
const OracleFailureInfoEnumInv = invert(OracleFailureInfoEnum);
...
module.exports = {
  ...
  OracleErrorEnum,
  OracleErrorEnumInv,
  OracleFailureInfoEnum,
  OracleFailureInfoEnumInv
};
