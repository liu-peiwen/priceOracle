...
contract ExponentialTest is Exponential, AssertHelpers {
    ...
    function testGreaterThanExp() public {
        // identity
        Assert.isFalse(greaterThanExp(getExpFromRational(1, 1), getExpFromRational(1, 1)), "1/1 <= itself");
        Assert.isFalse(greaterThanExp(getExpFromRational(1, 3), getExpFromRational(1, 3)), "1/3 <= itself");
        Assert.isFalse(greaterThanExp(getExpFromRational(3, 1), getExpFromRational(3, 1)), "3/1 <= itself");
        Assert.isFalse(greaterThanExp(getExpFromRational(0, 1), getExpFromRational(0, 3)), "0  <= itself even with different demoninators");
        Assert.isFalse(greaterThanExp(getExpFromRational(11 * 10**17, 3), getExpFromRational(110 * 10**16, 3)), "(11 * 10**17)/3  <= itself");

        // less than
        Assert.isFalse(greaterThanExp(getExpFromRational(7, 9), getExpFromRational(1, 1)), "7/9 <= 1");
        Assert.isFalse(greaterThanExp(getExpFromRational(1, 4), getExpFromRational(1, 3)), "1/4 <= 1/3");
        Assert.isFalse(greaterThanExp(getExpFromRational(3, 2), getExpFromRational(3, 1)), "3/2 <= 3 ");
        Assert.isFalse(greaterThanExp(getExpFromRational(100, 3), getExpFromRational(100, 2)), "100/3  <= 100/2");
        Assert.isFalse(greaterThanExp(getExpFromRational(10**18, 3), getExpFromRational(10**19, 3)), "10e18/3 <= 10e19/3");

        // Reverse the previous block of less than tests
        Assert.isTrue(greaterThanExp(getExpFromRational(1, 1), getExpFromRational(7, 9)), "1 !<= 7/9 ");
        Assert.isTrue(greaterThanExp(getExpFromRational(1, 3), getExpFromRational(1, 4)), "1/3 !<= 1/4");
        Assert.isTrue(greaterThanExp(getExpFromRational(3, 1), getExpFromRational(3, 2)), "3 !<= 3/2");
        Assert.isTrue(greaterThanExp(getExpFromRational(100, 2), getExpFromRational(100, 3)), "100/2 !<= 100/3");
        Assert.isTrue(greaterThanExp(getExpFromRational(10**19, 3), getExpFromRational(10**18, 3)), "10e19/3 !<= 10e18/3");

        // Let's do some more failure cases
        Assert.isFalse(greaterThanExp(getExpFromRational(1, 3), getExpFromRational(3, 1)), "1/3 and 3/1");
        Assert.isFalse(greaterThanExp(getExpFromRational(1, 1), getExpFromRational(3, 1)), "1/1 and 3/1");
        Assert.isFalse(greaterThanExp(getExpFromRational(0, 1), getExpFromRational(3, 1)), "0/1 and 3/1 ");
        Assert.isFalse(greaterThanExp(getExpFromRational(3, 1), getExpFromRational(30, 1)), "3/1 and 30/1");
    }
